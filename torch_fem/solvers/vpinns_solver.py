...
from ..element import ElementLine
from ..basis import InteriorEdgesBasis
from ..model.neural_network import FeedForwardNeuralNetwork as NeuralNetwork


class VPINNsSolver(DeepSolver):
    ...
    def precompute_values(
        ...
        basis, precomputed_values, error_mesh = self._precompute_values(
        ...
        return basis, precomputed_values, error_mesh
