...
V_xd = Basis(mesh, Elements(P_order = 1, 
                    int_order = 2))

exact_norm_xd = torch.sqrt(torch.sum(V.integrate_functional(H1_exact)))

print(torch.norm(exact_norm - exact_norm_xd)/torch.norm(exact_norm_xd))
